#ifndef __ALGORITHM_D_H
#define __ALGORITHM_D_H
...
class _313178576_D : public AbstractAlgorithm
{
private:
...
public:
	_313178576_D() {};
	_313178576_D(const _313178576_D&) = delete;
	_313178576_D& operator=(const _313178576_D&) = delete;
